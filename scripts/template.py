...
redis_template_float = Template(
    """
dbLoadRecords("database/${TYPE}.db", "DESCRIPTION=$DESCRIPTION, REDIS_KEY=$REDIS_KEY, PREC=$PREC, PORT=redisPort, RECORD_NAME=$RECORD_NAME, SCANRATE=$SCANRATE, EGU=$EGU, HIHI_VAL=$HIHI, HI_VAL=$HIGH, LOLO_VAL=$LOLO, LO_VAL=$LOW$EXTRA")"""
)
